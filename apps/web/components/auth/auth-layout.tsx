    ...
    >
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">Collaborative Task Platform</h1>
          <p className="mt-2 text-sm text-gray-600">Real-time collaborative task management</p>
        </div>
